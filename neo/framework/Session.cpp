...
/* Going to attempt to hack this to not require a CD key at all for at least singleplayer */
/* TODO: Look for server key auth and disable it as well */
...
/*	if ( !xp ) {
	...
	// We might need to make up a key here to return as "valid"
	return NULL;
}
